...
mixin _$Position {
  int get row =>
      throw _privateConstructorUsedError; // 0-7, where 0 = Player 1 (white) back rank
...
class _$PositionImpl extends _Position {
  ...
  @override
  final int row;
  // 0-7, where 0 = Player 1 (white) back rank
  @override
  final int col;
...
abstract class _Position extends Position {
  ...
  @override
  int get row; // 0-7, where 0 = Player 1 (white) back rank
  @override
  int get col;
